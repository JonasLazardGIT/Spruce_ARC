...
The committed issuance witness consists of the carrier rows
\[
...
\]
the BB-tran auxiliary product rows
\[
M_{\Sigma}R_1,\ R_0R_1,
\]
and the non-sign replay aliases
\[
\widehat M,\ \widehat K,\ \widehat R_0,\ \widehat R_1,\ \widehat{M_{\Sigma}R_1},\ \widehat{R_0R_1}.
\]
The exact carrier-to-source bridges are
\[
M-\mathrm{Dec}_M^{(1)}(C^M)=0,
\qquad
K-\mathrm{Dec}_M^{(2)}(C^M)=0,
\]
\[
R_0^U-\mathrm{Dec}_{\mathrm{preRU}}^{(1)}(C^{\mathrm{preRU}})=0,
\qquad
...
\]
\[
R_0-\mathrm{Dec}_{\mathrm{ctr}}^{(1)}(C^{\mathrm{ctr}})=0,
\qquad
R_1-\mathrm{Dec}_{\mathrm{ctr}}^{(2)}(C^{\mathrm{ctr}})=0,
\]
\[
J_0-\mathrm{Dec}_J^{(1)}(C^J)=0,
\qquad
J_1-\mathrm{Dec}_J^{(2)}(C^J)=0.
\]
The non-sign transform bridges are
\[
\widehat M = \mathcal F_{\mathrm{ns}}(M),
\qquad
\widehat K = \mathcal F_{\mathrm{ns}}(K),
\qquad
\widehat R_0 = \mathcal F_{\mathrm{ns}}(R_0),
\qquad
\widehat R_1 = \mathcal F_{\mathrm{ns}}(R_1),
\]
and in canonical BB-tran mode also
\[
\widehat{M_{\Sigma}R_1}=\mathcal F_{\mathrm{ns}}(M_{\Sigma}R_1),
\qquad
\widehat{R_0R_1}=\mathcal F_{\mathrm{ns}}(R_0R_1),
\]
where \(\mathcal F_{\mathrm{ns}}\) denotes the public lift used by the pre-sign replay.
...
\begin{enumerate}[leftmargin=1.25em]
    ...
    \item the explicit source row family \(T\) together with the BB-tran
    auxiliary product rows
    \[
    M_{\Sigma}R_1,\ R_0R_1;
    \]
    ...
    \]
    \[
    \widehat{M_{\Sigma}R_1}_0,\ldots,\widehat{M_{\Sigma}R_1}_{B_{\mathrm{rep}}-1},
    \qquad
    \widehat{R_0R_1}_0,\ldots,\widehat{R_0R_1}_{B_{\mathrm{rep}}-1};
    \]
...
shortness gadget and is tied to the source row \(T\) by the source-side equation \(T=Au\). The carrier-to-source bridges are
\[
...
\]
The BB-tran auxiliary products satisfy
\[
...
\]
\[
\widehat{M_{\Sigma}R_1}_b=\mathcal F_{\mathrm{rep},b}(M_{\Sigma}R_1),
\qquad
...
\[
\mathcal F_{\mathrm{rep},b}(B_3T)
-
\mathcal F_{\mathrm{rep},b}(TR_1)
-
...
\bigl(B_3T-TR_1-B_0-B_1(M+K)-B_2R_0\bigr)=0.
\]
By Lemma~\ref{lem:replay-transform}, \(\mathcal F_{\mathrm{rep}}\) is injective. Hence
\[
B_3T-TR_1-B_0-B_1(M+K)-B_2R_0=0
\]
in \(\Rq\). Since the compiled showing relation also enforces \(T=Au\), this immediately implies
\[
