...
In this work, we use the BBS-type rational hash defined in \cite[Table~1]{EPRINT:DKLW25}.

\begin{definition}[Rational hash, admissibility, and cleared form]\label{def:rational-hash}
Our concrete instantiation uses a public key \(B=(B_0,B_1,B_2,B_3)\in\Rq^4\), message \(m\in\Rq\), and 
...
\[
\operatorname{num}(B,m,r_0)=(n_1,\ldots,n_s),\,
...
All later uses of the rational hash state explicitly whether they refer to the quotient relation or to the weaker cleared relation.
