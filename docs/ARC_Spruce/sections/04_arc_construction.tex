...
Corollary~\ref{cor:showing-proof-consequence} yields a witness
\((u,T,M,K,R_0,R_1,MSigmaR1,R0R1)\) satisfying
\[
B_3Au-(Au)R_1-(B_3B_1)(M+K)-(B_3B_2)R_0+B_1MSigmaR1+B_2R0R1-1=0
\]
in \(R_q\), together with the derived identities
\[
MSigmaR1=(M+K)R_1,
\qquad
R0R1=R_0R_1.
\]
If moreover \(B_3-R_1\in R_q^\times\), then this coefficient-domain statement is
equivalent to the abstract BB-tran target equation
\[
Au = h^{\mathrm{bb\mbox{-}tran}}_{M+K,(R_0,R_1)}(B).
\]
