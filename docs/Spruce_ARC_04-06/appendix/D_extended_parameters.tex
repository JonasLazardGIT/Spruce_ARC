...
Table~\ref{tab:lattice-params} records one concrete instantiation used for the proof sizes in
Table~\ref{tab:proof-sizes}.
...
For the issuance and showing proofs reported in Table~\ref{tab:proof-sizes}, one example parameter tuple is:
\[
