...
\begin{itemize}[leftmargin=1.25em]
  ...
  \item \textbf{\(\mathsf{IntGenISIS}_f\).} This is an interactive version where the challenger offers a
  signing oracle with an additional linear masking term.
\end{itemize}
\cite{PKC:DKLW25} shows how this interactive problem reduces
  back to \(\mathsf{GenISIS}_f\) under increased parameters.
