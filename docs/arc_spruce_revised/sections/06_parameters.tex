...
accounted for as the rational-hash admissibility error $\delta$.  Since $r_1$ is the centered sum of holder and issuer
contributions, its distribution is the centered bounded distribution required by the target-hiding statement.
...
$T=\mA\vecu$, and the PRF checkpoint constraints.
