...
func intGenISISSecurityProfileSpecs() []IntGenISISSecurityProfileSpec {
	profiles := []IntGenISISSecurityProfileSpec{
		...
		},
		{
			...
			PackedKeyCoords:    IntGenISISPRFPoseidonKeyLen,
			Status:             SecurityProfileProofOnly,
			Notes:              "NIZK-only residual target under raw 2^64 caps for the five proof-system oracle domains; primitive security is an independent assumption.",
		},
		{
			Label:              "BQ96-128",
			Mode:               SecurityModeResidualAtBudget,
			...
			TargetBits:         128,
			CoreBitsRequired:   128,
			ROQueryCaps:        intGenISISSecurityProfileROQueryCaps(96),
			ROQueryCapBits:     intGenISISSecurityProfileROQueryCapBits(96),
			MinDECSHashBits:    328,
			MinDECSTapeBits:    232,
			MinFSCollisionBits: 328,
			MinSaltBits:        200,
			MinPRFTagElements:  10,
			SeedSlots:          IntGenISISPRFSeedLen,
			PackedKeyCoords:    IntGenISISPRFPoseidonKeyLen,
			Status:             SecurityProfileProofOnly,
			Notes:              "NIZK-only residual target under raw 2^96 caps for the five proof-system oracle domains; primitive security is an independent assumption.",
		},
		{
			Label:              "BQ128-128",
			Mode:               SecurityModeResidualAtBudget,
